  ...
  const companyInfo = [
    {
      ...
      description: "Rajesh Alloys has been a reputable player in the industry since 2015, gaining recognition for its commitment to excellence and delivering top-notch products and services.",
    },
    {
      icon: <AiOutlineBars />,
    ...
    },
    {
      ...
      description: "Recognizing the diverse requirements of clients, Rajesh Alloys offers its products in different specifications, providing tailored solutions to meet specific industry demands.",
    },
    {
      icon: <IoMdHappy />,
    ...
    },
    {
      ...
      description: "The products provided by Rajesh Alloys find extensive usage in various industries, showcasing their versatility and reliability for different purposes.",
    },
    {
      icon: <FaClock />,
    ...
    },
    {
      ...
      description: "Rajesh Alloys maintains stringent quality control measures to guarantee the consistency and superior performance of its products.",
    },
    {
      icon: <FaCog />,
