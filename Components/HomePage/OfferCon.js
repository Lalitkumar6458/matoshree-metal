...
const OfferCon = () => {
  ...
  return (
    ...
    {OfferData.map((item)=>{
        return (
            <div className='shadow-mainShadow p-4 relative group overflow-hidden border-[1px] border-solid border-b-4 border-dark-cl transition-all duration-700 rounded hover:border-0' key={item.id}>
