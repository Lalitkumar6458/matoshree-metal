...
<h1 className='text-[2rem] font-Oswald font-semibold'>RAJESH ALLOYS</h1>
<div className='w-[70px] h-1 bg-mainRed rounded mt-2'></div>
<p className='text-[1rem] font-poppins text-gray-500 mt-4 font-medium '>We deal into all kind of steel and alloys as per <br/> client requirement.</p>
<div className='w-[100%] md:w-[90%] h-[300px] overflow-hidden p-1 rounded-md border-[1px] border-solid border-gray-600 mt-3'>
