...
const list3=[
 ...
 const handleEmailClick = () => {
  ...
  return (
   ...
   <div className='grid grid-cols-1 max-[767px]:gap-6 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 md:gap-y-4 text-white '>
   ...
   Rajesh Alloys is a young and dynamic company founded in 2015, specializing in the stainless steel and alloys scrap business. We have rapidly emerged as a leader in the international markets, driven by our commitment to total quality and unmatched flexibility.
   </p>
   <div className='mt-3'>
   <span className='flex items-center gap-2 cursor-pointer' onClick={handleEmailClick}><FaEnvelope className='text-mainRed' /> <strong>alloysrajesh@gmail.com</strong> </span>
   <span className='flex items-center gap-2 mt-1 cursor-pointer'  onClick={handlePhoneClick} ><FaPhone className='text-mainRed'/> <strong>+91 6351709542 / 7340402970</strong></span>
...
|
   ...
   © {new Date().getFullYear()} Rajesh Alloys. All Right Reserved,  Design And Developed By <Link className='text-blue-400 text-[1.4rem]' href="https://www.linkedin.com/in/lalit-kumar-845a2123a"
